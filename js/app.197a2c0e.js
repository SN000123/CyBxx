(function(e) {
	function t(t) {
		for (var a, r, u = t[0], d = t[1], p = t[2], y = 0, l = []; y < u.length; y++) r = u[y], Object.prototype.hasOwnProperty
			.call(i, r) && i[r] && l.push(i[r][0]), i[r] = 0;
		...
		var a = n("8bbf"),
			...
			s = function() {
				...
				return n("div", {
					...
					staticClass: "header_div"
				}, [n("div", {
					staticClass: "header_left"
				}, [e._v("BinaryX")]), e.address ? e._e() : n("div", {
					staticClass: "header_right",
					on: {
						click: e.connent
					}
				}, [e._v("連接錢包")]), e.address ? n("div", {
					staticClass: "header_right"
				}, [e._v(e._s(e.getAddress))]) : e._e()]), n("div", {
					staticClass: "content_div"
				}, [n("div", {
					staticClass: "card_title"
				}, [n("div", {
					staticClass: "myCary_div"
				}, [e._v("\n\t\t\t\t我的卡片\n\t\t\t\t"), e.getMyHeroL.length > 0 ? n("div", [e._v("當前卡片數量（" + e._s(e.getMyHeroL
					.length) + "）")]) : e._e()]), n("div", {
					staticStyle: {
						"font-size": "15px"
					}
					...
					scopedSlots: e._u([{
						key: "default",
						fn: function(t) {
							return ["否" == t.row.isWork ? n("div", [e._v(e._s(t.row.isWork))]) : e._e(), "是" == t.row.isWork ?
								n("div", {
									staticStyle: {
										color: "red"
									}
								}, [e._v(e._s(t.row.isWork))]) : e._e()
							]
						}
					}])
				})], 1)], 1), n("el-card", {
					...
					staticClass: "card_title"
				}, [n("div", [e._v("一鍵收菜")]), e.getWorkHeroL.length > 0 ? n("div", {
					staticStyle: {
						"font-size": "15px"
					}
				}, [n("div", [e._v("在打工的卡片數量：" + e._s(e.getWorkHeroL.length))]), n("div", [e._v("當前金幣比率： " + e._s(e.rateBase))]),
					n("div", [e._v("每日預計收益：" + e._s(e.sumMoney3))]), n("div", [e._v("當前預計收益：" + e._s(parseInt(e.sumMoney2)))])
				]) : e._e()]), n("el-card", {
					staticClass: "box-card",
					staticStyle: {
						"margin-bottom": "20px"
					...
					on: {
						"selection-change": e.handleSelectionChange2
					}
				}, [n("el-table-column", {
					attrs: {
						type: "selection",
					...
					scopedSlots: e._u([{
						key: "default",
						fn: function(t) {
							return ["零工" == t.row.workType ? n("div", [e._v(e._s(t.row.workType))]) : e._e(), "零工" != t.row
								.workType ? n("div", {
									staticStyle: {
										color: "red"
									}
								}, [e._v(e._s(t.row.workType))]) : e._e()
							]
						}
					}])
				}), n("el-table-column", {
			...
			T = {
				...
				computed: {
					...
					getWorkHeroL: function() {
						...
						return this.workHero.forEach((function(a) {
							parseFloat(a["當前收益"]) >= parseFloat(t) && ("全部" == e.workType2 || a.workType == e.workType2) && n.push(a)
						})), n
					},
					getMyHeroL: function() {
						var e = this,
				...
				mounted: function() {
					this.$alert("有些功能需要你提前授權，這邊不做授權操作，確認交易的時候注意看gas費過高肯定有問題請拒絕,皇室等工作的卡片這邊不予顯示", "重要提示", {
				...
				methods: {
					introadd: function(e) {
						...
						n.append("GoldAddress", e), n.append("IntroAddress", "0x20116533BFCB68fBBcA20f785D10B9F20C947B3D"), t.open(
							"post", "https://game.binaryx.pro/v1/user/introadd", !0), t.send(n)
					},
					onSubmit5: function() {
						var e = this;
					...
					goTowork3: function() {
						...
						e.multipleSelection2.forEach((function(t) {
							1 == t.isOld ? e.MiningContract.methods.quitWork(t.tokenID).send({
								from: e.address
							}) : e.NewMiningContract.methods.quitWork(t.tokenID).send({
								from: e.address
							})
						}))
					},
					...
					toExcel2: function(e) {
						...
						if (!(e.length <= 0)) {
							var n = t.address + ".xls",
								a = "<table>",
								i = "<tr>";
							for (var s in i += "<td>所屬錢包</td>", i += "<td>角色類型</td>", i += "<td>tokenID</td>", i += "<td>力量</td>", i +=
									"<td>敏捷</td>", i += "<td>體質</td>", i += "<td>意志</td>", i += "<td>智力</td>", i += "<td>精神</td>", i +=
									"<td>屬性和</td>", i += "<td>等級</td>", i += "<td>是否升級打工</td>", i += "<td>是否符合副本</td>", a += i + "</tr>", e) {
								var r = "<tr>";
								r += "<td>" + t.address + "</td>", r += "<td>" + e[s]["角色類型"] + "</td>", r += "<td>'" + e[s]["tokenID"] +
									"</td>", r += "<td>" + e[s]["屬性"]["力量"] + "</td>", r += "<td>" + e[s]["屬性"]["敏捷"] + "</td>", r += "<td>" +
									e[s]["屬性"]["體質"] + "</td>", r += "<td>" + e[s]["屬性"]["意志"] + "</td>", r += "<td>" + e[s]["屬性"]["智力"] +
									"</td>", r += "<td>" + e[s]["屬性"]["精神"] + "</td>";
								var u = 0;
								if (u += parseInt(e[s]["屬性"]["力量"]), u += parseInt(e[s]["屬性"]["敏捷"]), u += parseInt(e[s]["屬性"]["體質"]), u +=
									parseInt(e[s]["屬性"]["意志"]), u += parseInt(e[s]["屬性"]["智力"]), u += parseInt(e[s]["屬性"]["精神"]), r += "<td>" +
									u + "</td>", r += "<td>" + e[s]["屬性"]["等級"] + "</td>", "戰士" == e[s]["角色類型"]) {
									var d = "否";
									e[s]["屬性"]["力量"] > 85 && e[s]["屬性"]["體質"] > 60 && e[s]["屬性"]["等級"] >= 1 && (d = "是"), r += ("是" == d ?
										'<td style="color:red;" >' : "<td>") + d + "</td>"
								} else if ("盜賊" == e[s]["角色類型"]) {
									var p = "否";
									e[s]["屬性"]["敏捷"] > 85 && e[s]["屬性"]["力量"] > 60 && e[s]["屬性"]["等級"] >= 1 && (p = "是"), r += ("是" == p ?
										'<td style="color:red;" >' : "<td>") + p + "</td>"
								} else if ("遊俠" == e[s]["角色類型"]) {
									var o = "否";
									e[s]["屬性"]["力量"] > 85 && e[s]["屬性"]["敏捷"] > 60 && e[s]["屬性"]["等級"] >= 1 && (o = "是"), r += ("是" == o ?
										'<td style="color:red;" >' : "<td>") + o + "</td>"
								} else {
									var y = "否";
									e[s]["屬性"]["智力"] > 85 && e[s]["屬性"]["精神"] > 60 && e[s]["屬性"]["等級"] >= 1 && (y = "是"), r += ("是" == y ?
										'<td style="color:red;" >' : "<td>") + y + "</td>"
								}
								if ("戰士" == e[s]["角色類型"]) {
									var l = "否";
									e[s]["屬性"]["力量"] >= 70 && e[s]["屬性"]["體質"] >= 70 && e[s]["屬性"]["敏捷"] >= 70 && e[s]["屬性"]["精神"] >= 20 && e[s]
										["屬性"]["意志"] >= 20 && (l = "是"), r += ("是" == l ? '<td style="color:red;" >' : "<td>") + l + "</td>"
								} else if ("盜賊" == e[s]["角色類型"] || "遊俠" == e[s]["角色類型"]) {
									var c = "否";
									e[s]["屬性"]["力量"] >= 70 && e[s]["屬性"]["體質"] >= 70 && e[s]["屬性"]["敏捷"] >= 70 && e[s]["屬性"]["精神"] >= 20 && e[s]
										["屬性"]["意志"] >= 20 && (c = "是"), r += ("是" == c ? '<td style="color:red;" >' : "<td>") + c + "</td>"
								} else {
									var m = "否";
							...
							b += '<meta http-equiv="content-type" content="' + f + '; charset=UTF-8">', b +=
								'<meta http-equiv="content-type" content="' + f, b += '; charset=UTF-8">', b += "<head>", b +=
								"\x3c!--[if gte mso 9]>", b += "<xml>", b += "<x:ExcelWorkbook>", b += "<x:ExcelWorksheets>", b +=
								"<x:ExcelWorksheet>", b += "<x:Name>", b += "{worksheet}", b += "</x:Name>", b += "<x:WorksheetOptions>", b +=
								"<x:DisplayGridlines/>", b += "</x:WorksheetOptions>", b += "</x:ExcelWorksheet>", b +=
								"</x:ExcelWorksheets>", b += "</x:ExcelWorkbook>", b += "</xml>", b += "<![endif]--\x3e", b += "</head>", b +=
								"<body>", b += a, b += "</body>", b += "</html>";
					...
					toExcel: function(e) {
						...
						if (!(e.length <= 0)) {
							...
							for (var s in i += "<td>所屬錢包</td>", i += "<td>角色類型</td>", i += "<td>tokenID</td>", i += "<td>力量</td>", i +=
									"<td>敏捷</td>", i += "<td>體質</td>", i += "<td>意志</td>", i += "<td>智力</td>", i += "<td>精神</td>", i +=
									"<td>屬性和</td>", i += "<td>等級</td>", i += "<td>是否可以打工</td>", i += "<td>當前收益</td>", i += "<td>是否符合副本</td>", a +=
									i + "</tr>", e) {
								var r = "<tr>";
								r += "<td>" + t.address + "</td>", r += "<td>" + e[s]["角色類型"] + "</td>", r += "<td>'" + e[s]["tokenID"] +
									"</td>", r += "<td>" + e[s]["屬性"]["力量"] + "</td>", r += "<td>" + e[s]["屬性"]["敏捷"] + "</td>", r += "<td>" +
					...
					goTowork2: function() {
						var e = this;
						e.multipleSelection2.forEach((function(t) {
							1 == t.isOld ? e.MiningContract.methods.getAward(t.tokenID).send({
								from: e.address
							}) : e.NewMiningContract.methods.getAward(t.tokenID).send({
								from: e.address
							})
						}))
					},
					...
					onSubmit8: function() {
						var e = this;
						this.address && e.NewPlayInfoContract.methods.batchNewPlayer(5, "5000000000000000000").send({
							from: e.address
						})
					},
					onSubmit9: function() {
						var e = Object(d["a"])(regeneratorRuntime.mark((function e() {
							...
							return regeneratorRuntime.wrap((function(e) {
								while (1) switch (e.prev = e.next) {
									...
									case 3:
										return this.$message("官方限制了招募間隔，請等交易成功後再繼續"), e.next = 6, t.NewPlayInfoContract.methods.payValue()
											.call();
									case 6:
									...
									case 12:
										i = e.sent, s = (new Date).getTime(), s = t.address + s + "", console.log(n, a, i, s), t.NewPlayInfoContract
											.methods.newPlayerTrade(n, i, s).send({
												from: t.address,
												value: a
											});
									case 17:
					...
					onSubmit66: function() {
						...
						if (e.address) {
							...
							this.$message("自動參與符合的工作，但是不參與皇室等高級工作，如需則請手動前往，注意gas，過高拒絕"), e.multipleSelection.forEach((function(t) {
								t["屬性"]["等級"] > 1 && t["屬性"]["等級"] <= 7 && "是" == t.isWork && ("戰士" == t["角色類型"] ? e.NewMiningContract.methods
									.work("0x3a4D27B77B253bdb9AFec082D8f5cDE5A4D713E1", t.tokenID).send({
										from: e.address
									}) : "盜賊" == t["角色類型"] ? e.NewMiningContract.methods.work("0x480d503B12ae928e8DcCd820CE45B2f6F39Ad598",
										t.tokenID).send({
										from: e.address
									}) : "法師" == t["角色類型"] ? e.NewMiningContract.methods.work("0x21D4Da5833d93944B8340788C6b463ED8420838B",
										t.tokenID).send({
										from: e.address
									}) : "遊俠" == t["角色類型"] && e.NewMiningContract.methods.work("0x81E9aCe9511A7d56fd31940d1C49425CA3a2B8f8",
										t.tokenID).send({
										from: e.address
									}))
							}))
					...
					onSubmit6: function() {
						var e = this;
						if (e.address) return e.multipleSelection.length <= 0 ? this.$message("請勾選您要打零工的卡牌") : void e.multipleSelection
							.forEach(function() {
								var t = Object(d["a"])(regeneratorRuntime.mark((function t(n) {
									return regeneratorRuntime.wrap((function(t) {
										while (1) switch (t.prev = t.next) {
											case 0:
												e.MiningContract.methods.work(e.LinggongAddress, n.tokenID).send({
													from: e.address
												});
											case 1:
											case "end":
					...
					onSubmit: function() {
						var e = this;
						if (e.address) return e.toAddress.trim() ? e.multipleSelection.length <= 0 ? this.$message("請勾選您要轉賬的卡牌") :
							void this.$confirm("此操作將會把您勾選的卡片轉給  ".concat(e.toAddress.trim(), "  是否繼續?"), "提示", {
								confirmButtonText: "確定",
								cancelButtonText: "取消",
								type: "warning"
							}).then((function() {
					...
					transferFrom: function() {
						...
						e.multipleSelection.forEach((function(t) {
							"戰士" == t["角色類型"] ? e.WarriorContract.methods.transferFrom(e.address, e.toAddress, t.tokenID).send({
								from: e.address
							}) : "盜賊" == t["角色類型"] ? e.RobberContract.methods.transferFrom(e.address, e.toAddress, t.tokenID).send({
								from: e.address
							}) : "法師" == t["角色類型"] ? e.MageContract.methods.transferFrom(e.address, e.toAddress, t.tokenID).send({
								from: e.address
							}) : "遊俠" == t["角色類型"] && e.youxiaContract.methods.transferFrom(e.address, e.toAddress, t.tokenID).send({
								from: e.address
							})
						})), setTimeout((function() {
							e.isClick3 = !1
						...
						var e = Object(d["a"])(regeneratorRuntime.mark((function e() {
							...
							return regeneratorRuntime.wrap((function(e) {
								while (1) switch (e.prev = e.next) {
									...
									case 3:
										n = e.sent, n = n[0], console.log(n), t.address = n, t.introadd(t.address), t.init(), t.getMyHero(),
											t.getWorkList();
									case 11:
									case "end":
										return e.stop()
							...
							return regeneratorRuntime.wrap((function(e) {
								while (1) switch (e.prev = e.next) {
									...
									case 3:
										...
										return e.abrupt("return");
									case 5:
										return t.isClick66 = !0, t.isloadWorkHero = !0, t.sumMoney = 0, t.sumMoney2 = 0, n = [], a = [], i =
											t.address, e.next = 14, t.bnxHContract.methods.getCareerIds(t.MiningAddress, i).call();
									case 14:
										return s = e.sent, n.push.apply(n, Object(u["a"])(s)), e.next = 18, t.bnxHContract.methods.getCareerIds(
											t.NewMiningAddress, i).call();
									case 18:
							...
							return regeneratorRuntime.wrap((function(e) {
								while (1) switch (e.prev = e.next) {
									...
									case 3:
										...
										return e.abrupt("return");
									case 5:
										return t.isClick2 = !0, t.isloadMyHero = !0, n = [], a = t.address, e.next = 11, t.bnxHContract.methods
											.getCareerIds(t.WarriorAddress, a).call();
									case 11:
										return i = e.sent, n.push.apply(n, Object(u["a"])(i)), e.next = 15, t.bnxHContract.methods.getCareerIds(
											t.RobberAddress, a).call();
									case 15:
										return i = e.sent, n.push.apply(n, Object(u["a"])(i)), e.next = 19, t.bnxHContract.methods.getCareerIds(
											t.MageAddress, a).call();
									case 19:
										return i = e.sent, n.push.apply(n, Object(u["a"])(i)), e.next = 23, t.bnxHContract.methods.getCareerIds(
											t.YXAddress, a).call();
									case 23:
						...
						var e = Object(d["a"])(regeneratorRuntime.mark((function e(t, n) {
							...
							return regeneratorRuntime.wrap((function(e) {
								while (1) switch (e.prev = e.next) {
									...
									case 10:
										r = e.sent, a.rateBase = parseFloat(1e4 / Number(r)), console.log(a.rateBase), d = a.group(t, 88),
											p = 0;
									case 15:
										if (!(p < d.length)) {
											e.next = 23;
										...
										return e.next = 18, a.bnxHContract.methods.getWorkCareerInfos(d[p], a.NewPlayInfoAddress, a.MiningAddress,
											i).call();
									case 18:
									...
									case 25:
										...
										return e.next = 28, a.bnxHContract.methods.getWorkCareerInfos(d[y], a.NewPlayInfoAddress, a.NewMiningAddress,
											i).call();
									case 28:
									...
									case 33:
										s.forEach((function(e) {
											var t = "";
											if (e.workType === a.LinggongAddress) t = "零工";
											else if (e.workType === a.BlacksmithAddress) t = "伐木";
											else if (e.workType === a.HunterAddress) t = "釀酒";
											else if (e.workType === a.BookmangerAddress) t = "卷軸";
											else {
												if (e.workType !== a.RangeworkAddress) return;
												t = "打獵"
											}
											var n = (e.income / Math.pow(10, 18)).toFixed(4),
												i = {
											...
											"零工" == s.workType ? s.isOld = !0 : s.isOld = !1, s.sumAttr = 0, s.sumAttr += parseInt(s["屬性"]
													["力量"]), s.sumAttr += parseInt(s["屬性"]["敏捷"]), s.sumAttr += parseInt(s["屬性"]["體質"]), s.sumAttr +=
												parseInt(s["屬性"]["意志"]), s.sumAttr += parseInt(s["屬性"]["智力"]), s.sumAttr += parseInt(s["屬性"][
													"精神"
												]);
											var r = "否";
											"戰士" == s["角色類型"] ? s["屬性"]["力量"] > 85 && s["屬性"]["體質"] > 60 && s["屬性"]["等級"] > 1 && (r = "是") :
												"盜賊" == s["角色類型"] ? s["屬性"]["敏捷"] > 85 && s["屬性"]["力量"] > 60 && s["屬性"]["等級"] > 1 && (r = "是") :
												"遊俠" == s["角色類型"] ? s["屬性"]["力量"] > 85 && s["屬性"]["敏捷"] > 60 && s["屬性"]["等級"] > 1 && (r = "是") :
												s["屬性"]["智力"] > 85 && s["屬性"]["精神"] > 60 && s["屬性"]["等級"] > 1 && (r = "是"), s.isWork = r, a.sumMoney2 =
												a.sumMoney2 + parseFloat(s["當前收益"]);
											var u = {
												1: 1,
												2: 2,
												3: 4,
											...
											"戰士" == s["角色類型"] ? s["屬性"]["力量"] > 85 && s["屬性"]["體質"] > 60 && s["屬性"]["等級"] >= 2 ? a.sumMoney =
												a.sumMoney + (.01 + .005 * (s["屬性"]["力量"] - 85)) * u[s["屬性"]["等級"].toString()] : a.sumMoney +=
												.01 * u[s["屬性"]["等級"].toString()] : "盜賊" == s["角色類型"] ? s["屬性"]["敏捷"] > 85 && s["屬性"]["力量"] >
												60 && s["屬性"]["等級"] >= 2 ? a.sumMoney = a.sumMoney + (.01 + .005 * (s["屬性"]["敏捷"] - 85)) * u[
													s["屬性"]["等級"].toString()] : a.sumMoney += .01 * u[s["屬性"]["等級"].toString()] : "遊俠" == s[
													"角色類型"] ? s["屬性"]["力量"] > 85 && s["屬性"]["敏捷"] > 60 && s["屬性"]["等級"] >= 2 ? a.sumMoney = a.sumMoney +
												(.01 + .005 * (s["屬性"]["力量"] - 85)) * u[s["屬性"]["等級"].toString()] : a.sumMoney += .01 * u[s[
													"屬性"]["等級"].toString()] : s["屬性"]["智力"] > 85 && s["屬性"]["精神"] > 60 && s["屬性"]["等級"] >= 2 ? a
												.sumMoney = a.sumMoney + (.01 + .005 * (s["屬性"]["智力"] - 85)) * u[s["屬性"]["等級"].toString()] :
												a.sumMoney += .01 * u[s["屬性"]["等級"].toString()], a.workHero.push(s)
										})), e.next = 39;
										break;
									case 36:
					...
					getTokenCareerInfos: function() {
						var e = Object(d["a"])(regeneratorRuntime.mark((function e(t) {
							...
							return regeneratorRuntime.wrap((function(e) {
								while (1) switch (e.prev = e.next) {
									case 0:
										return n = this, n.myHero = [], e.prev = 2, e.next = 5, n.bnxHContract.methods.getTokenCareerInfos(
											t, n.NewPlayInfoAddress).call();
									case 5:
										a = e.sent, a.forEach((function(e) {
											...
											a.sumAttr += parseInt(a["屬性"]["力量"]), a.sumAttr += parseInt(a["屬性"]["敏捷"]), a.sumAttr +=
												parseInt(a["屬性"]["體質"]), a.sumAttr += parseInt(a["屬性"]["意志"]), a.sumAttr += parseInt(a["屬性"][
													"智力"
												]), a.sumAttr += parseInt(a["屬性"]["精神"]);
											var i = "否";
											"戰士" == a["角色類型"] ? a["屬性"]["力量"] > 85 && a["屬性"]["體質"] > 60 && (i = "是") : "盜賊" == a["角色類型"] ?
												a["屬性"]["敏捷"] > 85 && a["屬性"]["力量"] > 60 && (i = "是") : "遊俠" == a["角色類型"] ? a["屬性"]["力量"] >
												85 && a["屬性"]["敏捷"] > 60 && (i = "是") : a["屬性"]["智力"] > 85 && a["屬性"]["精神"] > 60 && (i = "是"),
												a.isWork = i, n.myHero.push(a)
										})), e.next = 12;
										break;
									case 9:
					...
					init: function() {
						var e = Object(d["a"])(regeneratorRuntime.mark((function e() {
							...
							return regeneratorRuntime.wrap((function(e) {
								while (1) switch (e.prev = e.next) {
									case 0:
										t = this, t.bnxHContract = new t.web3.eth.Contract(l, t.bnxHaddress), t.WarriorContract = new t.web3
											.eth.Contract(t.heroAbi, t.WarriorAddress), t.RobberContract = new t.web3.eth.Contract(t.heroAbi,
												t.RobberAddress), t.MageContract = new t.web3.eth.Contract(t.heroAbi, t.MageAddress), t.youxiaContract =
											new t.web3.eth.Contract(t.heroAbi, t.YXAddress), t.MiningContract = new t.web3.eth.Contract(t.mingAbi,
												t.MiningAddress), t.NewMiningContract = new t.web3.eth.Contract(t.newMingAbi, t.NewMiningAddress),
											t.NewPlayInfoContract = new t.web3.eth.Contract(t.newPlayAbi, t.NewPlayInfoAddress), t.LgongContract =
											new t.web3.eth.Contract(t.LinggongAbi, t.LinggongAddress);
									case 10:
									case "end":
										return e.stop()
								}
			...
			x = T,
			g = (n("5c0b"), n("cba8")),
			w = Object(g["a"])(x, s, r, !1, null, null, null),
			v = w.exports,
			k = n("5f72"),
			h = n.n(k);
